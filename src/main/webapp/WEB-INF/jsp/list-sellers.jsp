                                        ...
                                        <div class="col-md-push-1 col-md-10">
                                                    ...
                                                    <c:forEach var="seller" items="${sellers}">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="${deleteLink}" class="btn btn-default" onclick="if (!(confirm('Etes-vous sur de vouloir supprimer ce vendeur ?'))) return false">Supprimer</a>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
                                            ...
                                            <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                                <div class="btn-group mr-2" role="group" aria-label="First group">
                                                    <a href="/StoreManager/sellers/addForm" class="btn btn-default">Ajouter vendeur</a></div>
                                            </div>
                                        </div>
				</div>
			</div>
