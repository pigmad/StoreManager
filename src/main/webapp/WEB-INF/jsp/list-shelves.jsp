                                        ...
                                        <div class="col-md-push-1 col-md-10">
                                            <table id="shelvesTable" class="table table-striped table-bordered post-list-table">
                                              ...
                                              <tbody> 
                                                    ...
                                                    <c:forEach var="shelf" items="${shelves}">
                                                        ...
                                                        <tr>
                                                            <td>${shelf.name}</td>
                                                            <td><a href="/StoreManager/stores/list">${shelf.store.city}</a></td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <c:if test="${user.getClass() == 'class entity.Director'}">
                                                                    ...
                                                                    <a href="${deleteLink}" class="btn btn-default" onclick="if (!(confirm('Etes-vous sur de vouloir supprimer ce rayon ?'))) return false">Supprimer</a>
                                                                </c:if>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
                                            ...
                                            <c:if test="${user.getClass() == 'class entity.Director'}">
                                                ...
                                                <div class="btn-group mr-2" role="group" aria-label="First group">
                                                    <a href="/StoreManager/shelves/addForm" class="btn btn-default">Ajouter rayon</a></div>
                                                </div>
                                            </c:if>
                                        </div>
                                </div>
