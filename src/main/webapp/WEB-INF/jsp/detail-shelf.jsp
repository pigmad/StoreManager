                                                    ...
                                                    <c:forEach var="item" items="${shelf.items}">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="${ItemDeleteLink}" class="btn btn-default" onclick="if (!(confirm('Etes-vous sur de vouloir supprimer cet article ?'))) return false">Supprimer</a>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
                                                ...
                                                <c:when test="${user.getClass() == 'class entity.Director'}"> 
                                                    <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                                        <div class="btn-group mr-2" role="group" aria-label="First group">
                                                            ...
                                                            <a href="${ShelfDeleteLink}" class="btn btn-default" onclick="if (!(confirm('Etes-vous sur de vouloir supprimer ce rayon ?'))) return false">Supprimer rayon</a>
                                                        </div>
                                                    </div>
                                                </c:when>
                                                <c:otherwise>
